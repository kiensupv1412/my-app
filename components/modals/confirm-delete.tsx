...
import { cn } from '@/lib/utils'; // nếu bạn có helper cn, không thì bỏ và nối chuỗi className bình thường
...
type Props = {
    ...
    title: string;                 // ví dụ: "Delete <tên bài viết>."
    description?: string;          // ví dụ: "Are you sure you would like to do this?"
    confirmText?: string;          // mặc định: "Delete"
    cancelText?: string;           // mặc định: "Cancel"
    loading?: boolean;
    className?: string;            // tuỳ chọn: thêm class cho Content
};
